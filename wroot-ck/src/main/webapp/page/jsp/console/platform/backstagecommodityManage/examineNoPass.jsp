...
<body>
	...
	<form class="form-horizontal validate" role="form" method="post">
		...
		<div class="form-group">
			...
			<div class="col-sm-6 ">
				<label for="parentId" class="col-sm-6"  >请说明审核不通过原因*</label>
			  <textarea class="form-control" rows="5" name=examineRemarks  value=${ entity.examineRemarks } data-rule-required="true" >${ entity.examineRemarks }</textarea>
			</div>
