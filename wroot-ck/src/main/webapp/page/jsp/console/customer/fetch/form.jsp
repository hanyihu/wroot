...
<body>
	...
	<form class="form-horizontal validate" role="form" method="post">
		...
		<div class="form-group">
			...
			<div class="col-sm-6 ">
				<select class="form-control" id="status" name="status"
					data-value="${ entity.status }" data-rule-required="true">
		...
		<div class="form-group">
			...
			<div class="col-sm-6 ">
				<input type="text" class="form-control" id="denyReason"
					name="denyReason" value="${ entity.denyReason }"
					data-rule-required="true" placeholder="请输入不通过的原因">
			</div>
			<div class="col-sm-4  help-inline form-control-static"></div>
		</div>
