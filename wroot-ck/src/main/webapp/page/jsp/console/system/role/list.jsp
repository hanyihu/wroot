	...
	<div class="row row-nocol">
		<form class="form-inline lookup" role="form" method="post">
			<div class="form-group">
				<label class="sr-only" for="lookup-name">角色名称</label> 
				<input 	type="text" class="form-control" id="lookup-name" name="name" value="${pager.lookup.name }" placeholder="请输入角色名称">
			</div>
						...
						<tr>
							...
							<td>
								<div class="btn-group btn-group-dis">
									...
									<button class="btn btn-xs btn-info action-get"  type="button" data-btn="config"
										data-href="authority/${cur.id }" data-toggle="tooltip" title="配置权限">
										<i class="glyphicon glyphicon-wrench"></i>
									</button>
									
									<button class="btn btn-xs btn-danger action-get" data-btn="delete" type="button"
