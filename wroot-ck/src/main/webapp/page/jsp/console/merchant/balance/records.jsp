	...
	<div class="row row-nocol">
		<form class="form-inline lookup" role="form" method="post">
			...
			<div class="form-group">
				<label class="sr-only" for="lookup-mobile">类型</label> 
				<select	class="form-control" id="lookup-status" name="type"data-value="${ pager.lookup.type }">
		...
		<form class="nocol">
			<div class="action-bar">
				<a class="btn btn-sm btn-success" href="${ctx }/console/merchant/balance/"> 
