...
<form class="form-horizontal validate" role="form" method="post">
    <div class="form-group">
        ...
        <div class="col-sm-6 ">
            ...
            <a href="https://open.weibo.com/authentication">微博开放平台</a>&nbsp;&nbsp;
        </div>
        <div class="col-sm-4  help-inline form-control-static"></div>
    </div>

    <c:if test="${thirdInterface.id==10 || thirdInterface.id==11}">
        <div class="form-group">
    ...
    <c:if test="${thirdInterface.id==11 || thirdInterface.id==12}">
        <div class="form-group">
    ...
    <c:if test="${thirdInterface.id==10}">
        <div class="form-group">
