...
public class JedisUtil {
    ...
    //public static final String KEY_PREFIX =PropertiesUtil.getStringByKey("redis.keyPrefix");

	static {
		
		JedisPoolConfig config = new JedisPoolConfig();
		config.setMaxIdle(Integer.parseInt(PropertiesUtil
				.getStringByKey("redis.pool.maxIdle")));
		config.setMaxWaitMillis(Long.parseLong(PropertiesUtil
				.getStringByKey("redis.pool.maxWait")));
		config.setMaxTotal(Integer.parseInt(PropertiesUtil
				.getStringByKey("redis.pool.maxTotal")));
		config.setTestOnBorrow(Boolean.parseBoolean(PropertiesUtil
				.getStringByKey("redis.pool.testOnBorrow")));
		String redisIp = PropertiesUtil.getStringByKey("redis.host");
		int port = Integer.parseInt(PropertiesUtil.getStringByKey("redis.port"));
		String password = PropertiesUtil.getStringByKey("redis.password");
		jedisPool = new JedisPool(config, redisIp, port, 100000, password);
